...
public class ProdutoController {
    ...
    public Produto getProdutoById(@PathVariable Long id) {
        return produtos
                .findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Produtos não encontrado"));
    }
    ...
    @PutMapping("{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void updade(@Valid @RequestBody Produto produto, @PathVariable Long id) {
